...
% \label{methoda1}
% \begin{tabular}{
% >{\columncolor[HTML]{ECF4FF}}l ll}
% \hline
% \multicolumn{1}{c}{\cellcolor[HTML]{ECF4FF}\textbf{Categories}}           & \multicolumn{1}{c}{\cellcolor[HTML]{ECF4FF}\textbf{Advantages}}                                        & \multicolumn{1}{c}{\cellcolor[HTML]{ECF4FF}\textbf{Disadvantages}}                                                   \\ \hline
