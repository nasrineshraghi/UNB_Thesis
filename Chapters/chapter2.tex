...
\begin{table}[!h]{}
\centering
\caption{Main distance functions used for computing proximity measures \protect%\cite{xu2015comprehensive}
}
    \label{tabdis}
...
mathematically, and has rich applications in the literature \cite{jain1999data}. 
...
\begin{table}[h]
    \centering
    \caption{ Overview of data stream clustering methods \cite{mansalis2018evaluation}}
    \label{landmarkwin}
    \small
    ...
    \hline 
     ...
     \hline
     CluDistream         &     2007       &   EM Algorithm    &  Online-offline     &  Landmark \\
    \hline 
