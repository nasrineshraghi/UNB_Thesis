...
\begin{figure}[!h]
    ...
    \includegraphics[width=.5\textwidth]{image/Chapters/Chapter6/kmeans_oneweek6Cluster.png}%29apriloneweek
...
\begin{figure}[]
    \centering
    \includegraphics[width=.49\textwidth]{image/Chapters/Chapter6/window10H.png}%ecounter_time data
