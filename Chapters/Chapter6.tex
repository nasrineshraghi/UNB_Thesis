...
Processing Time (s)                  & 28                     & \cellcolor[HTML]{68CBD0}0.6                                                                \\ \hline
Memory Consumption (MB)              & 536                    & \cellcolor[HTML]{68CBD0}250                                                                \\ \hline
Number of Clusters                   & 9                      & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 11\\ macro =  5\end{tabular}    \\ \hline
Silhouette Index                     & 0.3                    & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 0.5\\ macro = 0.5\end{tabular}  \\ \hline
Caliński-Harabasz Index              & 1009                   & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro =  2308\\ macro = 87\end{tabular} \\ \hline
Davies-Bouldin Index                 & 0.5                    & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 0.9\\ macro = 0.5\end{tabular}  \\ \hline
...
Memory Consumption (MB)              & 519                    & \cellcolor[HTML]{68CBD0}256                                                                \\ \hline
Number of Clusters                   & 14                     & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro =  14\\ macro = 7\end{tabular}    \\ \hline
Silhouette Index                     & 0.4                    & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 0.5\\ macro = 0.5\end{tabular}  \\ \hline
Caliński-Harabasz Index              & 1421                   & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 1974\\ macro = 35\end{tabular}  \\ \hline
Davies-Bouldin Index                 & 0.5                    & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 2.1\\ macro = 0.7\end{tabular}  \\ \hline
...
Number of Clusters                   & 12                     & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 14\\ macro = 8\end{tabular}     \\ \hline
Silhouette Index                     & 0.4                    & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 0.6\\ macro = 0.5\end{tabular}  \\ \hline
Caliński-Harabasz Index              & 1278                   & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 3153\\ macro = 80\end{tabular}  \\ \hline
Davies-Bouldin Index                 & 0.5                    & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 0.7\\ macro = 0.5\end{tabular}  \\ \hline\midrule
\end{tabular}
\end{table}
