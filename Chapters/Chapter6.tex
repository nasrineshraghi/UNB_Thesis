...
\begin{figure}[]
    ...
    \includegraphics[width=.49\textwidth]{image/Chapters/Chapter6/streamKbefore.png}
    \caption{Clustering results from DSAP and streaming K-means algorithms applied on the e-counter data for the first week before intervention.}
    \label{26}
\end{figure}
...
The UJIIndoorLoc dataset is similarly happened as the e-counter dataset. To find a pattern in this data, first AP and K-means clustering algorithms were performed to find people activities in these three buildings during experiment period. As our computer used for this study could not handle the whole experience duration for clustering data by AP, one day of experiment with the total number of 14688 data points is selected. This day includes all people in the experiment but building T1 is not presented in this specific day. The K-means algorithm was able to handle to total amount of data points.
