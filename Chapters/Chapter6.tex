...
The data from each of the three periods of the experiment were analyzed using the DSAP algorithm with an expiration time representing a month. The resulting micro and macro clusters along with the number of branch points are shown in Figure. \ref{dsap3mon} .
...
% \end{minipage}
% \caption{Clustering results from DSAP algorithm applied on the e-counter data for the first week before, during, and after the intervention period. Window size =1 hour, damping = 0.9.} \label{fig:b}
...
% \end{minipage}
% \caption{Clustering results from DSAP and streaming K-means algorithms applied on the e-counter data for the first week of intervention 29 April- 5 May. , damping = 0.9.} \label{fig:d}
...
Number of Clusters                   & 13                      & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 15\\ macro =  4\end{tabular}    \\ \hline
...
Number of Clusters                   & 11                     & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro =  16\\ macro = 4\end{tabular}    \\ \hline
...
Number of Clusters                   & 12                     & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 16\\ macro = 4\end{tabular}     \\ \hline
...
% \hline
% \multicolumn{1}{c}{\textbf{Metrics}} & \multicolumn{1}{l}{\cellcolor[HTML]{DAE8FC}\textbf{AP Algorithm}} & \multicolumn{1}{l}{\cellcolor[HTML]{68CBD0}\textbf{DSAP Algorithm}}     \\ \hline\midrule
% \multicolumn{4}{c}{\cellcolor[HTML]{FFCCC9}\textbf{Before Intervention Week (March 18 - March 24)}}                                                                                                                                                                   \\ \hline
% Processing Time (s)                     & 28                                                      & \cellcolor[HTML]{68CBD0}0.6                                                                  & 0.85                                                                  \\ \hline
...
% Caliński-Harabasz Index              & 1009                                                     & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro =  2308\\ macro = 87\end{tabular} & \begin{tabular}[c]{@{}c@{}}micro = \\ macro = 150\end{tabular}        \\ \hline
...
% Processing Time (s)                     & 26                                                      & \cellcolor[HTML]{68CBD0}0.6                                                                  & 0.8                                                                   \\ \hline
% Memory Consumption (MB)              & 541                                                     & \cellcolor[HTML]{68CBD0}260                                                                  & 224                                                                   \\ \hline
% Number of Clusters                   & 12                                                      & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 14\\ macro = 5\end{tabular}       & \begin{tabular}[c]{@{}c@{}}micro = \\ macro = 6\end{tabular}          \\ \hline
% Silhouette Index                     & 0.4                                                    & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 0.58\\ macro = 0.4\end{tabular}   & \begin{tabular}[c]{@{}c@{}}micro = \\ macro = 0.61\end{tabular}       \\ \hline
% Caliński-Harabasz Index              & 1278                                                     & \cellcolor[HTML]{68CBD0}\begin{tabular}[c]{@{}c@{}}micro = 3153\\ macro = 80\end{tabular}    & \begin{tabular}[c]{@{}c@{}}micro = \\ macro = 80\end{tabular}         \\ \hline
...
%     \caption{AP algorithm is applied on e-counter data for one week. The first week before intervention. with the damping = 0.9 and preference(np.median(similarity matrix) = -4 }
%     \label{befA}
% \end{figure}
...
%     % \includegraphics[width = 11 cm]{image/Chapters/Chapter6/17ap.96Y.png}%ecounter_time data
%     \caption{AP algorithm is applied on e-counter data for one week. The first week of intervention: 29 April- 5 May. with the damping = 0.9 and preference(np.median(similarity matrix) = -50 }
%     \label{oneweek}
% \end{figure}
...
%     \caption{AP algorithm is applied on e-counter data for one week. The first week after intervention. with the damping = 0.9 and preference(np.median(similarity matrix)=.7  }
%     \label{apaft}
% \end{figure}
...
% \multicolumn{4}{c}{\cellcolor[HTML]{FFCCC9}\textbf{Intervention Week (April 29 - May 5)}}                                                                                                                                 \\ \hline
% Processing Time (s)                      & 26                                             & 0.6                                                       & 0.9                                                                  \\ \hline
...
% \begin{table}[!h]
% \small
% \caption{Comparison of AP, DSAP, K-means, and Streaming K-means Evaluation Metrics for the first week of intervention (Apr 29 - May 5).AP: Damping=0.9 and preference is the median value of the similarity matrix.}
% \label{all3}
% \begin{tabular}{l
% >{\columncolor[HTML]{CBCEFB}}c 
% >{\columncolor[HTML]{FFCCC9}}c 
...
This experiment is located at the UJI university campus with three buildings and four to five floors. The most relevant parameters for current study are the location of people or spaceID and people's phone corresponding the location of each person. 
...
\textbf{Processing Time (s)}         & 414                    & 5                                                                  \\ \hline
\textbf{Memory Consumption (MB)}     & 1933                   & 271                                                                \\ \hline
\textbf{Number of Clusters}          & 5                      & \begin{tabular}[c]{@{}c@{}}micro = 101\\ macro =  8\end{tabular}    \\ \hline
\textbf{Silhouette Index}            & 0.3                    & \begin{tabular}[c]{@{}c@{}}micro = 0.85\\ macro = 0.8\end{tabular}  \\ \hline
\textbf{Caliński-Harabasz Index}     & 7193                   & \begin{tabular}[c]{@{}c@{}}micro =  2308\\ macro = 87\end{tabular} \\ \hline
\textbf{Davies-Bouldin Index}        & 0.7                    & \begin{tabular}[c]{@{}c@{}}micro = 0.9\\ macro = 0.5\end{tabular}  \\ \hline\midrule
\end{tabular}
\end{table}
